...
from myDtaDateset import MyDataset
# from model import DeepDTAF, test
from dtamodel import DTA, test
...
# data_path = r'E:\Python\TrAdaboost\canruntr\MyTrAdaBoost\labelData\AllDATA\TransferData\test'
