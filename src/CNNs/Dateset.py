...
class MyDataset(Dataset):
    def __init__(self, data_path, phase, max_seq_len, max_pkt_len, max_smi_len):
        ...
        with open(self.train_path, 'r') as f:
            for line in f.readlines():
                ...
                sse.append(one_hot_sse(line[3],self.SEQLEN,self.charsseset))
                y.append(int(line[4]))
    ...
    def __getitem__(self, idx):
        ...
        return self.seqtensor[idx], self.smiletensor[idx], self.labeltensor[idx],self.sse[idx],self.y[idx]
