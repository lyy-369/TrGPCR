...
from DatasetMCNN import MyDataset
from mcnn import CNN, test
print(sys.argv)
...
# data_path = r'F:\test'
data_path = r'/2211041012/MCNN/MCNN/test'
...
def training(model, training_loader, loss_function, optim):
    ...
    model.train()
    n = 0
    for _, (seq, smile, y) in enumerate(training_loader):
        for seq, smile, y in training_loader:
            seq = seq.to(device)
